...
export const customersGrid = [
  ...
  { field: 'location',
    ...
    textAlign: 'Center' },
    {
      field: 'email', // Nouvelle colonne "email" avec le champ "field" défini sur "email"
      headerText: 'Email', // Texte de l'en-tête de la colonne
      width: '200', // Largeur de la colonne
      textAlign: 'Center', // Alignement du texte dans la colonne
    },
...
export const pieChartData = [
  { x: 'Web Development', y: 18, text: '18%' },
  { x: 'Apps Development', y: 8, text: '8%' },
  { x: 'Graphic Design UI/UX', y: 15, text: '15%' },
  { x: 'Mobile Development', y: 11, text: '11%' },
  { x: 'IT Consulting', y: 18, text: '18%' },
  { x: 'Digital Marketing', y: 14, text: '14%' },
  { x: 'Referencing', y: 16, text: '16%' },
];
